...
if __name__ == '__main__':
    ...
    gen_ikr.loc[gen_ikr[gen_ikr.is_cntlreg == False].index, 'value'] = 0
    ...
    for a1, a2 in n_plt:
        ...
        if sum(gen.pct_delta == 0) != len(gen):
            ...
            my_map.save(results_path +
                        f'/summary_maps/generation/{a1}_r{a2}_pct_delta_gen_cntlreg.html')
    ...
    for a1, a2 in n_plt:
        ...
        if sum(gen.value == 0) != len(gen):
            ...
            # folium.LayerControl(collapsed=True).add_to(my_map)
            my_map.save(results_path + f'/summary_maps/generation/{a1}_r{a2}_abs_gen_cntlreg.html')
