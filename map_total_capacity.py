...
if __name__ == '__main__':
    ...
    for a1, a2 in n_plt:
        ...
        if sum(cap.pct_delta == 0) != len(cap):
            ...
            my_map.save(results_path +
                        f'/summary_maps/total_capacity/{a1}_r{a2}_pct_delta_tot_cap.html')
    ...
    for a1, a2 in n_plt:
        ...
        if sum(cap.value == 0) != len(cap):
            ...
            colormap.caption = 'Total Generation Capacity (MW)'
            my_map.add_child(colormap)
            ...
            # folium.LayerControl(collapsed=True).add_to(my_map)
            my_map.save(results_path + f'/summary_maps/total_capacity/{a1}_r{a2}_abs_tot_cap.html')
